            ...
            <div class="cbx-backend-row">
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Get Free & Pro Addons', 'cbxlatesttweets' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-row">
                                        ...
                                        <div class="feature-card-body static">
                                            <div class="feature-card-header">
                                                <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                   target="_blank"> <img src="https://codeboxr.com/wp-content/uploads/productshots/14006-profile.png"
                                                                         alt="CBX Latest Tweets Pro Addon for WordPress"/> </a>

                                            </div>
                                            <div class="feature-card-description">
                                                <h3>
                                                    <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                       target="_blank">CBX Latest Tweets Pro Addon</a></h3>
                                                <p>Pro features for CBX Latest Tweets plugin.</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="cbx-backend-card dashboard-plugin-Integration">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Third Party plugin Integration', 'cbxlatesttweets' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <p>
									...
									<?php esc_html_e( 'Coming Soon', 'cbxlatesttweets' ); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Other WordPress Plugins', 'cbxlatesttweets' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
							<?php
							...
							if ( function_exists( 'fetch_feed' ) ) {
								...
								if ( ! is_wp_error( $feed ) ) : $feed->init();
									...
									foreach ( $blocks as $block ) {
										...
										$url = CBXLatestTweetsHelper::url_utmy( $url ); ?>
                                        <div class="cbx-backend-settings-row">
                ...
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card dashboard-support">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Help & Supports', 'cbxlatesttweets' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
									...
									<?php esc_html_e( 'Access our Premium Support', 'cbxlatesttweets' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Currency%20Converter" target="_blank">
									...
									<?php esc_html_e( 'Quick Support (Email)', 'cbxlatesttweets' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $plugin_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'CBX Latest Tweets Plugin Information', 'cbxlatesttweets' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'Read the CBX Latest Tweets User Guide', 'cbxlatesttweets' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxlatesttweets/reviews/#new-post" target="_blank">
                                    <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<?php esc_html_e( 'Rate Our Plugin', 'cbxlatesttweets' ); ?> </a>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Changelog', 'cbxlatesttweets' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[New]</strong> Dashboard setting ui/ux improvements</li>
                                    <li><strong>[New]</strong> CSS is now generated as scss files</li>
                                    <li><strong>[New]</strong> Help & support page added</li>
                                    <li><strong>[New]</strong> WordPress 5.8 compatible</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[Bug Fix]</strong> Fix ‘cache clear’ broken link</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[NEW]</strong> WPBakery Page builder widget support added</li>
                                    <li><strong>[NEW]</strong> Plugin setting style updated</li>
                                    <li><strong>[NEW]</strong> 4 new layout style added</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[Bug Fix]</strong> Elementor widget loading conflict issue fixed</li>
                                </ul>
                            </div>
                            <p><a target="_blank" href="https://wordpress.org/plugins/cbxlatesttweets/#developers">View all change logs</a></p>
                        </div>
                    </div><!--End Changelog-->
                    <!--Codeboxr News-->
                    <div class="cbx-backend-card dashboard-wp-plugin">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Codeboxr News Updates', 'cbxlatesttweets' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
							<?php
